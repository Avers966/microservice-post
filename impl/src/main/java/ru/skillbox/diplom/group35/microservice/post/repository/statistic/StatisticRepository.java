...
public class StatisticRepository {
    ...
    public List<StatisticPerDate> getPostStatistic(PostStatisticRequestDto requestDto, String parameter) {
        ...
        Predicate betweenDate = builder.between(root.get(Post_.TIME), requestDto.getFirstMonth(), requestDto.getLastMonth().plusMonths(1));
        List<StatisticPerDate> stats = new ArrayList<>();
        setStats(stats, query, date, count, betweenDate);
        return stats;
    }
    ...
    public List<StatisticPerDate> getCommentStatistic(PostStatisticRequestDto requestDto, String parameter) {
        ...
        Expression<Long> count = builder.count(root);
        Predicate betweenDate = builder.between(root.get(Comment_.TIME), requestDto.getFirstMonth(), requestDto.getLastMonth().plusMonths(1));
        List<StatisticPerDate> stats = new ArrayList<>();
        setStats(stats, query, date, count, betweenDate);
        return stats;
    }
    ...
    public List<StatisticPerDate> getLikeStatistic(PostStatisticRequestDto requestDto, String parameter) {
        ...
        Expression<Long> count = builder.count(root);
        Predicate betweenDate = builder.between(root.get(Like_.TIME), requestDto.getFirstMonth(), requestDto.getLastMonth().plusMonths(1));
        List<StatisticPerDate> stats = new ArrayList<>();
        setStats(stats, query, date, count, betweenDate);
        return stats;
    }

    public void setStats(List<StatisticPerDate> stats, CriteriaQuery<Tuple> query,
                           Expression<Date> date, Expression<Long> count, Predicate betweenDate) {
